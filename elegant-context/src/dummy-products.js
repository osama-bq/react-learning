...
import rangeExpeditionVest from './assets/range-expedition-vest.jpg';
import alpinePlaidFlannel from './assets/alpine-plaid-flannel.jpg';
...
export const DUMMY_PRODUCTS = [
  ...
  },
  {
    ...
    {
      id: 'p6',
      image: rangeExpeditionVest,
      title: 'Range Expedition Canvas Vest',
      price: 119.99,
      description: 'Our Range Expedition Canvas Vest is built for the seasoned explorer. Crafted from heavy-gauge waxed canvas with leather trim and multiple utility pockets, this vest offers rugged durability and practical gear storage for any expedition.'
    },
    {
      id: 'p7',
      image: alpinePlaidFlannel,
      title: 'Alpine Trail Plaid Flannel Shirt',
      price: 59.99,
      description: 'The Alpine Trail Plaid Flannel Shirt is designed for cooler days and rugged landscapes. Crafted from heavyweight brushed cotton, this shirt offers unmatched warmth and a timeless outdoor aesthetic, perfect for the wilderness adventurer.'
    }
];
