...
function signupAction(prevFormState, formData) {
  ...
  const acquisionChannel = formData.getAll('acquisition');
  ...
  if (errors.length > 0) {
    return {
      errors, enteredValues: {
        email, password, confirmPassword, firstName, lastName, role, terms, acquisionChannel
      }
    };
  }
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.enteredValues?.acquisionChannel?.includes('google')}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultChecked={formState.enteredValues?.acquisionChannel?.includes('friend')}
          />
          <label htmlFor="friend">Referred by friend</label>
        </div>

        <div className="control">
          <input type="checkbox" id="other" name="acquisition" value="other" defaultChecked={formState.enteredValues?.acquisionChannel?.includes('other')} />
